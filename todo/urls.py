...
urlpatterns = [
    ...
    path('important/add/<int:pk>/', views.AddToImportantItemView.as_view(), name='add-important-item'),
    path('important/remove/<int:pk>/', views.RemoveImportantItem.as_view(), name='remove-important-item'),
